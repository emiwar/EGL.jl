...
const __WCHAR_MIN = -__WCHAR_MAX - 1
...
const INT64_MIN = -(__INT64_C(9223372036854775807)) - 1
...
const INT64_MAX = __INT64_C(9223372036854775807)
...
const UINT64_MAX = __UINT64_C(18446744073709551615)
...
const INT_LEAST64_MIN = -(__INT64_C(9223372036854775807)) - 1
...
const INT_LEAST64_MAX = __INT64_C(9223372036854775807)
...
const UINT_LEAST64_MAX = __UINT64_C(18446744073709551615)
...
const INT_FAST64_MIN = -(__INT64_C(9223372036854775807)) - 1
...
const INT_FAST64_MAX = __INT64_C(9223372036854775807)
...
const UINT_FAST64_MAX = __UINT64_C(18446744073709551615)
...
const INTMAX_MIN = -(__INT64_C(9223372036854775807)) - 1

const INTMAX_MAX = __INT64_C(9223372036854775807)

const UINTMAX_MAX = __UINT64_C(18446744073709551615)
